 ...
 */
class Version20160411171904 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql("INSERT INTO `fos_user_user` (`id`, `username`, `username_canonical`, `email`, `email_canonical`, `enabled`, `salt`, `password`, `last_login`, `locked`, `expired`, `expires_at`, `confirmation_token`, `password_requested_at`, `roles`, `credentials_expired`, `credentials_expire_at`, `created_at`, `updated_at`, `date_of_birth`, `firstname`, `lastname`, `website`, `biography`, `gender`, `locale`, `timezone`, `phone`, `facebook_uid`, `facebook_name`, `facebook_data`, `twitter_uid`, `twitter_name`, `twitter_data`, `gplus_uid`, `gplus_name`, `gplus_data`, `token`, `two_step_code`) VALUES (1, 'admin', 'admin', 'admin@admin.com', 'admin@admin.com', 1, 'edqydhlforw4kc4wg4gg4skks4gcsck', 'vkWcImYQ0mB+3iXhuRp/+6t05RwZaKqOMhDdEopVnZUwi1fEUoNwd39cfw8Pvmq0gr9iK3PXy1QKYkNAFJyjjQ==', '2016-05-14 15:41:42', 0, 0, NULL, NULL, NULL, 'a:1:{i:0;s:16:\"ROLE_SUPER_ADMIN\";}', 0, NULL, '2016-04-11 17:21:21', '2016-05-14 15:44:20', NULL, NULL, NULL, NULL, NULL, 'u', NULL, NULL, NULL, NULL, NULL, 'null', NULL, NULL, 'null', NULL, NULL, 'null', NULL, NULL);");
        $this->addSql("INSERT INTO `classification__context` (`id`, `name`, `enabled`, `created_at`, `updated_at`) VALUES ('default', 'default', 1, '2016-05-02 22:05:56', '2016-05-02 22:05:56');");
        $this->addSql("INSERT INTO `classification__category` (`id`, `parent_id`, `context`, `media_id`, `name`, `enabled`, `slug`, `description`, `position`, `created_at`, `updated_at`) VALUES (1, NULL, 'default', NULL, 'default', 1, 'default', 'default', NULL, '2016-05-02 22:06:49', '2016-05-02 22:06:49');");
    }
